...
We evaluated our ability to detect trends under sampling schemes where we sample 100%, 50% and 25% of survey sites. Across all subsampling simulations we used a stratified and weighted approach, where the sites (which we define as ponds) were stratified by habitat type and weighted by historical bird abudance. ...habitat type = managed pond or restored tidal marsh...weighting takes into account multiple species...adapts based on which species are already covered?? somewhat stochastic weights??
