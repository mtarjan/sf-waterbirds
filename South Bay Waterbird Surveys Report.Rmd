...
We will apply Wood et al.'s approach with modifications to the geographic scope, species, and detection criteria to identify feasible reductions in survey effort for the SBSPRP.  Previous analyses (Tarjan & Heyse 2018) revealed that survey frequency needs to remain at current levels (once in summer and twice in fall, winter, and spring) to detect Project targets. These results are in agreement with Wood et al.'s findings that decreasing survey effort to every two years dramatically lowers power. An alternative approach to decrease survey effort is to survey fewer locations, which we evaluate here. 
